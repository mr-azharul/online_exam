		...
		<div class="container">
			...
			<!-- Navbar -->
			  <div class="collapse navbar-collapse">
			      ...
			      <li class="active"><a href="<?php echo BASE_URL;?>/Index/exams">Exams</a></li>
    ...
    <div class="container">
	  <table class="table table-hover">
	    ...
	    <tbody>
			...
			?>
	      <tr>
	        <td><a href="<?php echo BASE_URL;?>/Exam/question?xuypx=<?php echo $exam_id;?>"><?php echo $value['exam_name'];?></a></td>
	        <td><?php echo $value['course_code']; ?></td>
	        <td><?php echo $value['date']; ?></td>
	        <td><?php echo $value['time']; ?></td>
	        <td><?php echo $value['end_time']; ?></td>
	        <td><?php echo $value['teacher_name']; ?></td>
	        <td><?php if($value['exam_status'] == 0) {echo "Active";} elseif ($value['exam_status'] == 1){echo "Completed";} ?></td>
	      </tr>
	      <?php } } ?>
	    </tbody>
	  </table>
